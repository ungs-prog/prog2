...
*Archivo:* [[file:tp0/Ejercicio1.java][Ejercicio1.java]].
...
e. /(Opcional)/ Implementar una versión de /PilaInt/ sobre un arreglo de enteros
   ...
   Archivo adicional que se debe entregar: [[file:tp0/opcional/PilaArr.java][PilaArr.java]].

   #+BEGIN_SRC java :tangle prog2/tp0/opcional/PilaArr.java :exports none :noweb-ref none
...
*Archivo:* [[file:tp0/Ejercicio2.java][Ejercicio2.java]].
...
d. /(Opcional)/ Implementar una versión recursiva de QuickSort:
   ...
   Archivo adicional que se debe entregar: [[file:tp0/opcional/Ordenamientos.java][Ordenamientos.java]].
...
*Archivo:* [[file:tp0/Ejercicio3.java][Ejercicio3.java]].
...
*Archivo:* [[file:tp0/FechaSimple.java][FechaSimple.java]].
